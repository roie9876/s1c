...
- A redacted capture is kept in [POC/Artifacts/har/github_login_redacted.har.json](../Artifacts/har/github_login_redacted.har.json) (headers, cookies, query strings, and bodies stripped).
